...
const Visualizer: React.FC<VisualizerProps> = ({ analyser, theme, extractedColor }) => {
    ...
    useEffect(() => {
        ...
        const render = () => {
            ...
            const r = (isMono || !extractedColor) ? 255 : extractedColor.r;
            const g = (isMono || !extractedColor) ? 255 : extractedColor.g;
            const b = (isMono || !extractedColor) ? 255 : extractedColor.b;
